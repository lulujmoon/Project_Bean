		...
		<div class="navbar-header navbar-default navbar-static-top"
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<span>Welcome</span> <a href="#">관리자 메뉴</a> <a href="#">Join</a> <a
						href="#">Login</a> <a
						href="${pageContext.request.contextPath}/cart/cartList">Cart</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="collapse navbar-collapse flex-grow-0 ml-auto">
			<ul class="navbar-nav text-right">
				<li class="nav-item"><a class="nav-link"
					...
					style="font-size: large;">Shop</a></li>
				<li class="nav-item"><a class="nav-link" href="#"
					style="font-size: large;">Location</a></li>

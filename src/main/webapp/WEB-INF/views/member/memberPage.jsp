		...
		<div class="wrapper container" style="display: block;">
			...
			<div id="content" class="cafe-content">
				<div class="bb-form mainpage-mobile" style="padding-bottom: 40px;">
					<a
						href="${pageContext.request.contextPath}/member/memberPoint?id=${member.id}"
						...
						<div
							class="mainpage-mobile-point-number mainpage-mobile-menu-right">
							<span class="mainpage-point">${member.point}</span> BP
						</div>
					</a> <a
						href="${pageContext.request.contextPath}/member/memberOrder?id=${member.id}"
						class="mainpage-mobile-menu"> 주문내역 조회
						<div class="mainpage-mobile-menu-right arrow"></div>
					</a> <a href="${pageContext.request.contextPath}/member/memberUpdate"
						class="mainpage-mobile-menu"> 회원정보 수정
						<div class="mainpage-mobile-menu-right arrow"></div>
					</a> <a
						href="${pageContext.request.contextPath}/member/memberPoint?id=${member.id}"
						class="mainpage-mobile-menu"> 내 포인트
						<div class="mainpage-mobile-menu-right arrow"></div>
					</a> <a href="${pageContext.request.contextPath}/member/memberQna"
						class="mainpage-mobile-menu"> 문의내역 조회
						<div class="mainpage-mobile-menu-right arrow"></div>
					</a>
				</div>
								...
								<div>
									<div class="sub-item-column-info">
										<div class="sub-item-option">
											<div class="sub-item-option-label">기본정보</div>
											<div class="sub-item-option-content">
												${member.name} | ${member.nickname} <br> ${member.tel}
												<br> ${member.id}
											</div>
										</div>
									</div>
						...
						<div class="sub-item mainpage-row">
							<div class="sub-item-column-product">
								<div class="mainpage-label">
									...
									<div class="mainpage-labellink">
										<a
											href="${pageContext.request.contextPath}/member/memberPoint?id=${member.id}">자세히
											보기 &gt;</a>
									</div>
								</div>
							</div>
						...
						<div class="sub-item mainpage-row">
							<div class="sub-item-column-product">
								<div class="mainpage-label">
									...
									<div class="mainpage-labellink">
										<a
											href="${pageContext.request.contextPath}/member/memberOrder?id=${member.id}">자세히
											보기 &gt;</a>
									</div>
								</div>
							</div>
									...
									<div class="sub-item-column-info">
										<div class="sub-item-option">
											<div class="sub-item-option-content">
												...
												<div>
													<a
														href="${pageContext.request.contextPath}/product/productList">온라인샵
														구경해보기 &gt;</a>
												</div>
											</div>
										</div>
